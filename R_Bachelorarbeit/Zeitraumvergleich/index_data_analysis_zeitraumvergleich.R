...
dataframe=read.csv("/Users/Aleks/Desktop/Studium/Bachelorarbeit/DataAnalytics/R projects/R_Bachelorarbeit/Zeitraumvergleich/corr_index_var_dataframe_final_export.csv", header = TRUE, sep = ",")
...
pdf("index_plots.pdf", width=811/72, height=478/72)
