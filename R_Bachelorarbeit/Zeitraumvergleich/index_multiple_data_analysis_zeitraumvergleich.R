...
dataframe=read.csv("/Users/Aleks/Desktop/Studium/Bachelorarbeit/DataAnalytics/R projects/R_Bachelorarbeit/Zeitraumvergleich/index_multiple_dataframe_final_export.csv", header = TRUE, sep = ",")
...
pdf("index_multiple_reg_analysis_plots.pdf", width=811/72, height=478/72)
