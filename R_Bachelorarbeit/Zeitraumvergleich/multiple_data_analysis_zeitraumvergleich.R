...
dataframe=read.csv("/Users/Aleks/Desktop/Studium/Bachelorarbeit/DataAnalytics/R projects/R_Bachelorarbeit/Zeitraumvergleich/multiple_dataframe_final_export.csv", header = TRUE, sep = ",")
...
for (bundesland_iterator in bundeslaender)
{
  ...
  dataset_bundesland=filter(dataframe, bundesland==bundesland_iterator, variable_y!="workplaces_percent_change_from_baseline", variable_y!="residential_percent_change_from_baseline")
...
pdf("multiple_reg_analysis_plots.pdf", width=811/72, height=478/72)
