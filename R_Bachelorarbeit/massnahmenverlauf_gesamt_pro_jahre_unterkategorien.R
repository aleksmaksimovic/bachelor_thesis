...
#reduce dataset to location "Bremen" and category M17 "Arbeitsplatzbeschränkung"
dataset_measure_category_p_year=filter(dataset_measure_category_p_year, bundesland == "Bremen" & m_code== "M17")
...
dataset_measure_category_p_year=filter_time(dataset_measure_category_p_year, ~'2020')
...
#reduce dataset to location "Bremen" and category which contains "M17"
...
dataset_measure_subcategory_p_year=filter(dataset_measure_subcategory_p_year, bundesland == "Bremen")
...
dataset_measure_subcategory_p_year=filter_time(dataset_measure_subcategory_p_year, ~'2020')
...
p<-ggplot(data_long,                       
       aes(x = date,
           ...
           col = measure)) +
  geom_line()+
  ggtitle("Workplace restrictions introduced by the government in Bremen (2020)")+
